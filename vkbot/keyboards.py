...
# Подписки продублированы здесь и в PLANNER_KB намеренно. Отписка жила за двумя
# экранами (Меню → Планировщик → Подписки), и найти её не получалось — а именно
# выключение уведомлений человек ищет тогда, когда они уже надоели, то есть
# быстро. Дубль в планировщике оставлен, чтобы не ломать привычный путь.
MAIN_KB = _kb(
    ["📅 Расписание"],
    ["🔔 Подписки на пары"],
    ["📝 Заметки", "⏰ Планировщик"],
